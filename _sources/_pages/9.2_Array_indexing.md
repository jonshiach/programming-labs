...
To print the middle 3 elements of `b` we use `start = 4` (since array indexing starts at 1, this is the 4th element of `b`) and `stop = 6` (as we want a step of 1 we don't need to specify this). Enter the following code to your program. 
